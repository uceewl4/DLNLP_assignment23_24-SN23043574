...
from A.fake_news.Pretrained import Pretrained
from A.fake_news.RNN import RNN
...
class Ensemble(nn.Module):
    def __init__(
        ...
        self.num_class = 6 if grained == "fine" else 2
        self.lr = lr
        self.epochs = epochs
        self.alpha = alpha
    ...
    def train(self, model, train_dataloader, val_dataloader):
        ...
        for epoch in range(self.epochs):
            ...
            # validation for selecting best weight
            ...
            for alpha in np.arange(0.1, 1, 0.25):
                ...
                if val_epoch_loss <= min_average_loss:  # less loss
                    self.alpha = alpha
                    print(
                        print(
